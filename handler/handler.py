...
class AirQuality(Resource):
    ...
    def get(self):
        ...
        return marshal(self.service.get_air_quality(), air_quality_fields), {'Access-Control-Allow-Origin': '*'}
...
class LcdScreen(Resource):
    ...
    def post(self):
        ...
        return marshal(GeneralResponse(status="OK"), general_response_fields), {'Access-Control-Allow-Origin': '*'}
